...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h2 className="text-3xl md:text-4xl font-black text-law-dark mb-6">About LLB28HUB</h2>
      ...
      {/* Mission & Vision */}
      <motion.section 
        className="py-16 bg-gradient-to-br from-blue-50 to-purple-50 border-t-4 border-black"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                At LLB28HUB, our vision is to redefine the future of legal education through 
      ...
      {/* History */}
      <motion.section 
        className="py-16 bg-gradient-to-br from-purple-50 to-blue-50 border-t-4 border-black"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                description: "Advanced AI tools to enhance your learning experience and academic performance.",
                features: ["IRAC Generator", "Case Brief Creator", "Contract Drafter", "Legal Memo Writer"]
              },
              {
                title: "Community Hub",
