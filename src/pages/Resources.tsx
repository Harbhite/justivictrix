...
import { FileText, Download, Book, Video, Loader2, File, ExternalLink, BookOpen, List, LogIn, Pin, PinOff, Edit, Trash, Filter, X, FileEdit } from "lucide-react";
...
import NoteTakerComponent from "@/components/NoteTaker";
...
const Resources = () => {
  ...
  useEffect(() => {
    if (resources && resources.length > 0 && activeTab === 'resources') {
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
          <TabsList className="grid grid-cols-2 mb-6 w-full md:w-80">
